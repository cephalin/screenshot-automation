...
var appName = "msdocs-python-postgres-2341";
var resourceGroupName = "msdocs-python-postgres-tutorial1";
var region = "UK West";
...
test('tutorial-python-postgresql-app', async ({ azPage, githubPage }) => {
    ...
    await azPage.runAppDbCreateWizard(subscription, resourceGroupName, region, appName, runtime, screenshotCreate2);
