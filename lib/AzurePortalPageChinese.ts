...
export class AzurePortalPageChinese extends DocsPageBase {
    ...
    async searchAndGo(type: SearchType, searchString: string, options?: {itemText?: string | undefined, id?: string | undefined, resourceType?: string | undefined, screenshotName?: string | undefined, clean?: boolean, dontGo?: boolean, otherHighlights?: Locator[]} | undefined): Promise<void> {
